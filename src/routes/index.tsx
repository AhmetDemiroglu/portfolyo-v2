        ...
        <div className="container z-10 mx-auto flex items-center justify-between px-8">
          ...
          >
            ...
            <div className="mt-8 flex items-center gap-6">
              <a href="https://github.com/AhmetDemiroglu" target="_blank" rel="noopener noreferrer" className="text-slate-400 transition hover:text-white"> <FaGithub size={28} /> </a>
              <a href="https://www.linkedin.com/in/ahmet-d-a11b8853/" target="_blank" rel="noopener noreferrer" className="text-slate-400 transition hover:text-white"> <FaLinkedin size={28} /> </a>
            </div>
          </motion.div>
          <motion.div
        ...
        <div className="container z-10 mx-auto flex flex-col items-center gap-12 px-8 md:flex-row">
          ...
          >
            ...
            <p className="mt-4 max-w-2xl text-lg text-slate-600 dark:text-slate-300">
              {t('home.career_section_paragraph')}
            </p>
          </motion.div>
        </div>
      </section>
